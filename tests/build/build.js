 ...
 * Created by yjh on 16/2/2.
 // */
System.register("Test", ['Core2D/SpriteBatchNode', 'Engine'], function(exports_1) {
    "use strict";
    var SpriteBatchNode_1, Engine_1;
    var UI;
    return {
        setters:[
        ...
        execute: function() {
            UI = new SpriteBatchNode_1.SpriteBatchNode();
            Engine_1.Engine.render.appendChild(UI);
        }
    }
});
//    var d1;
