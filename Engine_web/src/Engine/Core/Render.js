System.register(['./Object3D', '../Engine', '../Core3D/Camera'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var Object3D_1, Engine_1, Camera_1;
    var Render;
    return {
        setters:[
        ...
        execute: function() {
            Render = (function (_super) {
                ...
                function Render() {
                    ...
                    this.root = this;
                    this.isRoot = true;
                    this.p = Engine_1.Engine.settings.pixelRatio;
                    this.container = Engine_1.Engine.settings.container;
                ...
                Render.prototype.update = function () {
                    ...
                    Engine_1.Engine.eventBus.dispatchEvent("beforeupdate");
                    Engine_1.Engine.audioCtl.update();
                    this.gl.clear(this.gl.COLOR_BUFFER_BIT);
                    ...
                    Engine_1.Engine.eventBus.dispatchEvent("afterupdate");
                };
                return Render;
            })(Object3D_1.Object3D);
