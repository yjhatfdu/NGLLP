System.register(['../Base', '../Engine', './ResourceItem'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var Base, Engine_1, ResourceItem_1;
    var ResourceCtl;
    return {
        setters:[
            function (Base_1) {
                        ...
                        var newJob = function (name, url, cache, standAlone) {
                            if (/.+\.(jpg|png|jpeg)$/.test(url.toLowerCase())) {
                                ...
                                x.onload = function () {
                                    ...
                                    Engine_1.Engine.audioCtl.ctx.decodeAudioData(x.response, function (buffer) {
