        ...
        execute: function() {
            Sprite = (function (_super) {
                ...
                function Sprite(imageItem, x, y, w, h, sx, sy, sw, sh, frameCount, stride, zIndex) {
                    ...
                    _super.call(this, x || 0, y || 0, w || 2 * imageItem.width / Engine_1.Engine.render.designResolution[1], h || 2 * imageItem.height / Engine_1.Engine.render.designResolution[1]);
                    this.rotation = 0;
                    this.opacity = 1;
                ...
                Sprite.deserialize = function (object) {
                    //todo
                    var spr = new Sprite(Engine_1.Engine.resourceCtl.getItem(object.resourceName), object.x, object.y, object.w, object.h, object.sx, object.sy, object.sw, object.sh, object.frameCount, object.stride, object.zIndex);
