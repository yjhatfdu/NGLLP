    ...
    return {
        ...
        execute: function() {
            ...
            TweenItem = (function () {
                ...
                TweenItem.prototype.then = function (callback) {
            ...
            _TweenCtl = (function () {
                ...
                _TweenCtl.prototype.add = function (object, field) {
                    if (!object.uuid) {
                ...
                _TweenCtl.prototype.select = function (object, field) {
                    return this.add(object, field);
                };
                _TweenCtl.prototype.removeAllAnimations = function (object) {
                ...
                _TweenCtl.prototype.remove = function (object, field) {
                    delete this.animationList[object.uuid + field];
                };
                _TweenCtl.prototype.playAction = function (action) {
                ...
                _TweenCtl.prototype.update = function () {
