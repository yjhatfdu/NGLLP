System.register(['../Core/Object3D', '../Material/SpriteMaterial'], function(exports_1, context_1) {
    "use strict";
    ...
    var Object3D_1, SpriteMaterial_1;
    var SpriteBatchNode;
    return {
        setters:[
            ...
            function (SpriteMaterial_1_1) {
                SpriteMaterial_1 = SpriteMaterial_1_1;
            }],
        execute: function() {
            SpriteBatchNode = (function (_super) {
                __extends(SpriteBatchNode, _super);
                function SpriteBatchNode(size) {
                    if (size === void 0) { size = 32; }
                    _super.call(this);
                    this.material = SpriteMaterial_1.CreateSpriteMaterial();
                    this.updateCursor = 0;
            ...
            exports_1("SpriteBatchNode", SpriteBatchNode);
        }
    }
});
